...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //Hewan harimau = new Hewan(); (jika tanda "//" dihilangkan maka akan error)
        //Kucing anggora = (Kucing) harimau; // compile OK tetapi runtime error ClassCastException (jika tanda "//" dihilangkan maka akan error)
    }
